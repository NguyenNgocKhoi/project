    ...
    <div class="page row">
        <div class="menu">
            <div class="row justify-content-around align-items-center d-inline tools">
                <button class="btn btn-sm btn-primary h-100" @click="refreshList">
                    <i class="fas fa-redo"></i> Làm mới
                </button>
                <button class="btn btn-sm btn-success h-100" @click="goToAddContact">
                    <i class="fas fa-plus"></i> Thêm mới
                </button>

                <button
                    class="h-100 btn btn-sm btn-danger"
